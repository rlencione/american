...
function banana() {
    let url = navigator.geolocation.getCurrentPosition((position) => {
        ...
        url = `https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=imperial&appid=4a8b2af439cbc27f984c83f2e6a25a4b`
...
//inj
let injDate = new Date ("Jan, 1, 2022, 12:00 AM");
    today = new Date ();
    diff = 0;
    days = 1000*60*60*24;
...
//dmg
let dmgDate = new Date ("Jan, 1, 2022, 12:00 AM");
    today = new Date ();
    diff = 0;
    days = 1000*60*60*24;
